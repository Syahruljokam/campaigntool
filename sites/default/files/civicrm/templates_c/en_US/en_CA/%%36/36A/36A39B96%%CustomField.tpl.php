...
smarty_core_load_plugins(array('plugins' => array(array('function', 'help', 'CRM/Custom/Form/CustomField.tpl', 36, false),array('block', 'ts', 'CRM/Custom/Form/CustomField.tpl', 58, false),)), $this); ?>
...
?>
                        ...
                        <?php if ($this->_tpl_vars['element']['html_type'] == 'Radio' && $this->_tpl_vars['element']['is_view'] == 0): ?>
...
'); return false;" ><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>clear<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a>)</span>
                <?php elseif ($this->_tpl_vars['element']['data_type'] == 'File'): ?>
                    <?php if ($this->_tpl_vars['element']['element_value']['data']): ?>
                      <div id="attachStatusMesg_<?php echo $this->_tpl_vars['element_name']; ?>
" class="status hiddenElement"></div>
                      <div id="attachFile_<?php echo $this->_tpl_vars['element_name']; ?>
">
                        <span class="html-adjust"><br />
                            ...
                            <?php if ($this->_tpl_vars['element']['element_value']['displayURL']): ?>
                                <a href="#" onclick="popUp('<?php echo $this->_tpl_vars['element']['element_value']['imageURL']; ?>
'); return false;" ><img src="<?php echo $this->_tpl_vars['element']['element_value']['displayURL']; ?>
...
"><?php echo $this->_tpl_vars['element']['element_value']['fileName']; ?>
                            ...
                            <?php if ($this->_tpl_vars['element']['element_value']['deleteURL']): ?>
                                   <a href="#" onclick="showDeleteAttachment('<?php echo $this->_tpl_vars['element']['element_value']['fileName']; ?>
', '<?php echo $this->_tpl_vars['element']['element_value']['deleteURLArgs']; ?>
', <?php echo $this->_tpl_vars['element']['element_value']['fid']; ?>
, '#attachStatusMesg_<?php echo $this->_tpl_vars['element_name']; ?>
', '#attachFile_<?php echo $this->_tpl_vars['element_name']; ?>
'); return false;" title="<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Delete this file<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"><span class="icon red-icon delete-icon" style="margin:0px 0px -5px 20px" title="<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Delete this file<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"></span></a>
                            <?php endif; ?>
                        </span>
                      </div>
                    <?php endif; ?>
