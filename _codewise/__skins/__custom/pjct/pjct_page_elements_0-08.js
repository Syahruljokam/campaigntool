...
if (is_ie) {
	...
	if (!is_ie10up) {
		...
		if (!is_ie9up) {
			...
			iSSHTML += ' #search form div.form-item input#search-block-form, #search form div.form-item input#search-block-form-1, #search form div.form-item input#edit-search-block-form, #search form div.form-item input#edit-search-block-form-1, #search form div.form-item input#edit-search-block-form--2 { padding-top: 6px; padding-bottom: 0px; }';
			...
			if (!is_ie8up) {
				...
				iSSHTML += ' .view-event_list div.viewRow div.viewDateWrapper div.viewDate.styledOrange { filter: progid:DXImageTransform.Microsoft.gradient(StartColorStr=\'#fff5e6ab\', EndColorStr=\'#ffdeb67a\'); }';
				iSSHTML += ' .view-event_list div.viewRow div.viewDateWrapper div.viewDate.styledGreen { filter: progid:DXImageTransform.Microsoft.gradient(StartColorStr=\'#ffd9e8a2\', EndColorStr=\'#ffbbd581\'); }';
				iSSHTML += ' #takeActionRightColumn input[type="submit"] { filter: progid:DXImageTransform.Microsoft.gradient(StartColorStr=\'#ff95c00f\', EndColorStr=\'#ff79a814\'); }';
				...
				iSSHTML += ' #search form div.form-item input#search-block-form, #search form div.form-item input#search-block-form-1, #search form div.form-item input#edit-search-block-form, #search form div.form-item input#edit-search-block-form-1, #search form div.form-item input#edit-search-block-form--2 { padding-bottom: 1px; }';
				iSSHTML += ' #search form input.form-submit { height: 28px; margin-top: -31px; }';
...
// alert($('div.subColumnContainer div.subColumn3 div.latestNews').html())
			...
			$('div.subColumn3 div.styled', $_homePageSubColumnContainer).each( function() {
				homePageSubColumnMaxHeight = Math.max(homePageSubColumnMaxHeight, $(this).height());
			});

			$('div.subColumn3 div.styled', $_homePageSubColumnContainer).css({
				'min-height': (homePageSubColumnMaxHeight - 0) // Account for the top and bottom padding
			});

			$('div.subColumn3 div.tab', $_homePageSubColumnContainer).css({
				'min-height': (homePageSubColumnMaxHeight - 0 - 47) // Account for the top and bottom padding, plus the height of the tabs
			});
		};
	};
	...
	function PJCT_pI_rC_restyleTeaserContent() {
		// if (isMobileVersion) {
			...
			$('.viewDateEventType_communityevent').addClass('styledGreen');
			$('.viewDateEventType_peterjulianevent').addClass('styledOrange');
			...
			$('div.viewDate').each( function() {
				...
				// $('div.viewDate.styledOrange').closest('div.viewDateWrapper').addClass('styledOrange');

				// $('div.viewDate.styledGreen').closest('div.viewDateWrapper').addClass('styledGreen');
			});
		// };
	};
...
function PJCT_sCBOH() {
	// Show the take action content, based on the URL?
	if (URLHash) {
...
function rFP() {
	...
	// Scroll to the top of the page
		...
		// EITR_sTTOTP(); // Without this, a page will remain "in place" if/when you reload it
	};
