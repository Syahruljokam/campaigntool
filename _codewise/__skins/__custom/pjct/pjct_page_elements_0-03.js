...
iSSHTML += ' span.icon, div.ExpandOMatic span.ExpandOMaticGraphic, a.tooltipIcon, div.sliderNavPanelButtons div.sliderNavPanelButtonsInner button, #search form input.form-submit, li.primaryNav.menuParent a.primaryNav { background-image: url(' + fDPO + mFPO + 'media\/images\/icons\/_icon_sprite_01.png); }';
...
// iSSHTML += ' #headerContainerInner { background-image: url(' + fDPO + mFPO + 'media\/images\/_header_flag_01.png); }';
// iSSHTML += ' #headerContainerInner { background-image: url(' + fDPO + mFPO + 'media\/images\/_peter_julian_portrait_02_136x120.png); }';
...
//, li.primaryNav.menuParent
// a.primaryNav:active, a.primaryNav:hover, li.primaryNav.menuParent:hover a.primaryNav, li.primaryNav.menuParent:active a.primaryNav, li.primaryNav.menuParent.activated a.primaryNav, 

// iSSHTML += ' a.primaryNav.homeLink { background-image: url(' + fDPO + mFPO + 'media\/images\/icons\/_icon_sprite_01.png); }';
...
//			$_headerContainerInner.append($_socialMediaLinks);
		};
...
// alert('Show/hide take action content...')
...
//				$_bannerTabs.append($('<div class="bannerTabLinkContainer"><a href="#topOfPage" class="bannerTabLink">' + $('h2:first', $(this)).text() + '<\/a><\/div>'));
			});
		};
...
function rFP() {
	...
	$_footerContainerOuter = $('<div id="footerContainerOuter" \/>');
		...
		$_footerContainerInner = $('<div id="footerContainerInner" \/>');
			...
			$_FlashWarningContainer = $('<div id="FlashWarningContainer" \/>');
