...
iSSHTML += ' span.icon, div.ExpandOMatic span.ExpandOMaticGraphic, a.tooltipIcon, div.sliderNavPanelButtons div.sliderNavPanelButtonsInner button, #search form input.form-submit { background-image: url(' + fDPO + mFPO + 'media\/images\/icons\/_icon_sprite_01.png); }';
...
iSSHTML += ' #headerContainerOuter, #primaryNavContainer, a.primaryNav:active, a.primaryNav:hover, li.primaryNav.menuParent:hover a.primaryNav, li.primaryNav.menuParent:active a.primaryNav, li.primaryNav.menuParent.activated a.primaryNav, #bannerContainerOuter, #footerContainerOuter { background-image: url(' + fDPO + mFPO + 'media\/images\/_gui_sprite_01.jpg); }';
...
function PJCT_pI_rC() {
	...
	if ($_content.exists()) {
		...
		if ($_bannerContainer.exists()) {
			$_bannerRightColumn = $('<div id="bannerRightColumn">' + WTF + '<\/div>');
	...
	function PJCT_pI_rC_restyleSliders() {
		...
		if ($_bannerContainer.exists()) {
			...
			// Add banner tabs
			$_bannerTabs = $('<div id="bannerTabs">' + WTF + '<\/div>');
