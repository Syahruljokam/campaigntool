...
if (languagePreference == 'fr') {
	var ui_linkOpensInANewWindow = ui_linkOpensInANewWindow_fr;
	var ui_nextText = ui_nextText_fr;
	var ui_prevText = ui_prevText_fr;
	var ui_swipeToScroll1Finger = ui_swipeToScroll1Finger_fr;
	var ui_swipeToScroll2Fingers = ui_swipeToScroll2Fingers_fr;
	var ui_searchFieldWarningText = ui_searchFieldWarningText_fr;
	var ui_takeActionFormNameFieldWarningText = ui_takeActionFormNameFieldWarningText_fr;
	var ui_takeActionFormEmailFieldWarningText = ui_takeActionFormEmailFieldWarningText_fr;
	var ui_takeActionFormPostalFieldWarningText = ui_takeActionFormPostalFieldWarningText_fr;
	var ui_takeActionFormWarningText = ui_takeActionFormWarningText_fr;
};
...
if (is_ie) {
	...
	// IE9 and lower
	if (!is_ie10up) {
		iSSHTML += ' .greyGradient { -ms-filter: "progid:DXImageTransform.Microsoft.gradient(StartColorStr=\'#f4f4f4\', EndColorStr=\'#e8e8e8\')"; }'; /* IE9 & IE8 MUST have double quotes here */

		iSSHTML += ' .greyGradientInverted { -ms-filter: "progid:DXImageTransform.Microsoft.gradient(StartColorStr=\'#e8e8e8\', EndColorStr=\'#f4f4f4\')"; }';
		...
		iSSHTML += ' .view-event_list div.viewRow div.viewDateWrapper div.viewDate.styledOrange { -ms-filter: "progid:DXImageTransform.Microsoft.gradient(StartColorStr=\'#f5e6ab\', EndColorStr=\'#deb67a\')"; }';

		iSSHTML += ' .view-event_list div.viewRow div.viewDateWrapper div.viewDate.styledGreen { -ms-filter: "progid:DXImageTransform.Microsoft.gradient(StartColorStr=\'#d9e8a2\', EndColorStr=\'#bbd581\')"; }';
...
function PJCT_pI_rH() {
	if ($_header.exists()) {
		...
		if ($_utilityNav.exists()) {
			...
			$('a', $_utilityNav).each( function() {
				// Take action link
				if (($(this).text().toLowerCase() == 'take action') || ($(this).text().toLowerCase() == 'passez à l\'action')) {
		...
		if ($_primaryNav.exists()) {
			...
			// Position header NDP logo
			PJCT_positionPrimaryNavContainerInnerBg();
		};
	...
	// Position header NDP logo
	function PJCT_positionPrimaryNavContainerInnerBg() {
...
function PJCT_pI_rC() {
	...
	function PJCT_pI_rC_restyleTeaserContent() {
		// if (isMobileVersion) {
			...
			$('.viewDateEventTypecommunityevent').addClass('styledGreen');
			$('.viewDateEventTypepeterjulianevent').addClass('styledOrange');
...
$(window).bind('resize', function() { PJCT_positionPrimaryNavContainerInnerBg(); });
