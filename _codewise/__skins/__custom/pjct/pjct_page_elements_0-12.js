...
if (is_ie) {
	...
	if (!is_ie10up) {
		...
		iSSHTML += ' .view-event_list div.viewRow div.viewDateWrapper div.viewDate.styledPurple { -ms-filter: "progid:DXImageTransform.Microsoft.gradient(StartColorStr=\'#e1c4ed\', EndColorStr=\'#d3abe5\')"; }';
		iSSHTML += ' #takeActionRightColumn input[type="submit"] { -ms-filter: "progid:DXImageTransform.Microsoft.gradient(StartColorStr=\'#95c00f\', EndColorStr=\'#79a814\')"; }';
		...
		if (!is_ie9up) {
			...
			if (!is_ie8up) {
				...
				iSSHTML += ' .view-event_list div.viewRow div.viewDateWrapper div.viewDate.styledPurple { filter: progid:DXImageTransform.Microsoft.gradient(StartColorStr=\'#ffe1c4ed\', EndColorStr=\'#ffd3abe5\'); }';
				iSSHTML += ' #takeActionRightColumn input[type="submit"] { filter: progid:DXImageTransform.Microsoft.gradient(StartColorStr=\'#ff95c00f\', EndColorStr=\'#ff79a814\'); }';
	...
	function PJCT_resizeHomePageSubColumnHeights() {
		...
		if ($('div.subColumnContainer div.subColumn3 div.latestNews').exists()) {
			...
			$('div.subColumn3 div.styled', $_homePageSubColumnContainer).animate({
				'min-height': (homePageSubColumnMaxHeight - 22) // Why the fudge factor?
			}, 1000);

			$('div.subColumn3 div.tab', $_homePageSubColumnContainer).animate({
				'min-height': (homePageSubColumnMaxHeight - 64) // Account for the fudge factor, plus the height of the tabs
			}, 1000);
		};
	};
...
function PJCT_pI_rCBT() {
	...
	// if ($_body) {
		...
		if (isHomePage || $_body.hasClass('font')) {
